...
export default function CrowdTrendChart({ businessId, timeRange = '24hours' }: CrowdTrendChartProps) {
  ...
  useEffect(() => {
    fetchData();
    // 🔥 REAL-TIME: 10 saniyede bir güncelle
