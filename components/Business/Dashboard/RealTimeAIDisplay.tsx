          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold mt-2">
                {(latestAnalysis.crowd_density || 0).toFixed(1)}%
              </p>
            </div>
            <div className="text-5xl opacity-50">🔥</div>
          </div>
          <div className="mt-4 text-sm text-orange-100">
            {getDensityLabel(latestAnalysis.crowd_density || 0)}
          </div>
        </motion.div>
          ...
          {analyses.map((analysis) => (
            ...
            >
              ...
              <div className="text-right">
                <div className={`font-semibold ${getDensityColor(analysis.crowd_density || 0)}`}>
                  {(analysis.crowd_density || 0).toFixed(1)}%
                </div>
