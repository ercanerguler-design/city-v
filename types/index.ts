export interface Location {
  ...
  currentPeopleCount?: number; // Business IoT - Real-time people count from AI cameras
  priceLevel?: number; // Google API price level (1-4, ucuzdan pahalıya)
  website?: string; // Business website URL
  photos?: string[]; // Business photos array
